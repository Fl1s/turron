...
public class MinioService {
    ...
    /**
     * Uploads a PNG image to MinIO into a folder corresponding to the video ID.
     *
     * @param videoId     The ID of the video, used as the folder name.
     * @param frameFile   The PNG file of the extracted key frame.
     * @param frameNumber The frame number (used as the file name: 1.png, 2.png, ...).
     */
